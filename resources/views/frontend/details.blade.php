            ...
            <div class="px-5 py-6 bg-bluish-purple rounded-2xl">
                <div class="flex items-center justify-between">
                    ...
                    <div class="inline-flex items-center justify-between max-w-[150px]">
                        ...
                        <input type="number" name="entry_ticket" id="entry_ticket" class="text-center bg-transparent focus:outline-none" value="12" min="1" max="100">
            ...
            <div class="px-5 py-6 bg-bluish-purple rounded-2xl">
                <div class="flex items-center justify-between">
                    ...
                    <div class="inline-flex items-center justify-between max-w-[150px]">
                        ...
                        <input type="number" name="pro_ticket" id="pro_ticket" class="text-center bg-transparent focus:outline-none" value="44" min="1" max="100">
                        <button type="button" class="plusButton">
                            <img src="{{ asset('assets/svgs/ic-plus.svg') }}" alt="tickety-assets">
                        </button>
                    </div>
            ...
            <div class="px-5 py-6 bg-bluish-purple rounded-2xl">
                <div class="flex items-center justify-between">
                    ...
                    <div class="inline-flex items-center justify-between max-w-[150px]">
                        ...
                        <input type="number" name="enterprise_ticket" id="enterprise_ticket" class="text-center bg-transparent focus:outline-none" value="664" min="1" max="100">
                        <button type="button" class="plusButton">
                            <img src="{{ asset('assets/svgs/ic-plus.svg') }}" alt="tickety-assets">
                        </button>
                    </div>
